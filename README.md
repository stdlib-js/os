...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/os@v0.4.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ARCH, BYTE_ORDER, FLOAT_WORD_ORDER, NUM_CPUS, PLATFORM, configdir, homedir, tmpdir } from 'https://cdn.jsdelivr.net/gh/stdlib-js/os@v0.4.1-deno/mod.js';
```
